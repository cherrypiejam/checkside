...
class DefaultModel(BaseModel):
    ...
    def analyse(traces, env={}):
        ...
        paired = [
            ...
            if logic_time.num_instructions(traces[p[0]])
                != logic_time.num_instructions(traces[p[1]])
        ]
        ...
        results = [
            ((fst.posix.dumps(0), logic_time.num_instructions(traces[fst]))
            ,(snd.posix.dumps(0), logic_time.num_instructions(traces[snd])))
